  ...
  <div class="centrado">
    <table class="Estilo1">
      <tr>
        ...
        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
        <td>
          <span>FACTURA B {{ $sale->id+5000 }}</span><br>
          <span>Emisión: {{ \Carbon\Carbon::parse($sale->fechaEmision)->format('d/m/Y') }}</span><br>
        </td>
      </tr>
    	<tr>
      	<td align="right"><br><br><span>Socio N&ordm;:</span></td>
      	<td >&nbsp;</td>
      	<td align="left"><br><br><span>{{ $sale->group->nroSocio }}</span></td>
    	</tr>
    	<tr>
      	<td align="right">Nombre:</td>
      	<td align="right">&nbsp;</td>
      	<td align="left">{{ $sale->group->user->name }}</td>
    	</tr>
      <tr>
      	<td align="right">Documento:</td>
      	<td align="right">&nbsp;</td>
      	<td align="left">{{ $sale->user->nroDoc }}</td>
    	</tr>
    	<tr>
      	<td align="right">Domicilio:</td>
      	<td align="right">&nbsp;</td>
      	<td align="left">{{ $sale->user->group->direccion }}</td>
    	</tr>
    	<tr>
      	<td colspan=3>
      		<hr>
