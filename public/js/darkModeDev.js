function darkMode(valor){
  ...
  if(valor){
    ...
    el17.classList.add('text-secondary');
    el18.classList.add('text-secondary');
    el19.classList.add('text-secondary');
    el20.classList.add('text-secondary');
    el21.classList.add('text-white');
    el22.style.color = "white";
    el23.style.backgroundImage = null;
    // el23.style.backgroundImage = "url('images/242113.jpg')";
    ...
    el17.classList.remove('text-secondary');
    el18.classList.remove('text-secondary');
    el19.classList.remove('text-secondary');
    el20.classList.remove('text-secondary');
